            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="padding:40px 50px;">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="col-md-4">
                            <button type="button" class="btn btn-success btn-block btn-carga">Aceptar</button>
                        </div>
                    <div class="col-sm-12">
                        <div class="table-responsive">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" style="padding:40px 50px;">
                    ...
                    <div class="col-sm-12">
                        <button type="button" class="btn btn-success btn-block btn-carga-update">Aceptar</button>
                    </div>
                    <div class="col-sm-12">
                        <div class="table-responsive">
